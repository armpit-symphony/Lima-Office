...
| Deployment/update/attestation | Show worker deployment records, update/rollback records, attestation placeholders, and field checklists | `worker.deployment`, `governance.update_record` |
