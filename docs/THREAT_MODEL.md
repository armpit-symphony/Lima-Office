...
| Connector consent or scope drift | Elevation, disclosure | Connector scope expands without consent/revocation/object-property authorization evidence | Connector consent policy, scope review, connector readiness gates, live access false, revocation evidence | Scope mismatch, revoked consent, missing object/property auth mapping, prompt-injection unresolved | Connector consent, connector trust, connector readiness, connector scope review, taint evidence | schema_defined |
...
| Connector consent or scope drift | `governance.connector_consent`, `connector.trust`, `connector.readiness`, `connector.scope_review`, `taint.ref`, `evidence.artifact` | Consent/scope/readiness records keep live access false, secret material absent, blocked scopes explicit, object/property authorization mapped, revocation evidenced, and prompt-injection review required before any future live-review lane. |
