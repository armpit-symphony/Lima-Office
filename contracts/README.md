...
- [operator.channel.envelope.schema.json](v1/operator.channel.envelope.schema.json)
- [operator.control_plane.request.schema.json](v1/operator.control_plane.request.schema.json)
- [operator.control_plane.response.schema.json](v1/operator.control_plane.response.schema.json)
...
- [connector.defaults.schema.json](v1/connector.defaults.schema.json)
- [connector.slo_target.schema.json](v1/connector.slo_target.schema.json)
- [connector.score_threshold.schema.json](v1/connector.score_threshold.schema.json)
...
- [connector.defaults.email-defaults.example.json](examples/connector.defaults.email-defaults.example.json)
- [connector.defaults.browser-blocked-mvp.example.json](examples/connector.defaults.browser-blocked-mvp.example.json)
- [connector.defaults.rmm-it-approval-required.example.json](examples/connector.defaults.rmm-it-approval-required.example.json)
- [connector.defaults.tenant-override-review-required.example.json](examples/connector.defaults.tenant-override-review-required.example.json)
- [connector.slo_target.email-placeholder.example.json](examples/connector.slo_target.email-placeholder.example.json)
- [connector.slo_target.revocation-missed-failed-closed.example.json](examples/connector.slo_target.revocation-missed-failed-closed.example.json)
- [connector.score_threshold.default-lab-thresholds.example.json](examples/connector.score_threshold.default-lab-thresholds.example.json)
- [connector.score_threshold.blocked-mvp-categories.example.json](examples/connector.score_threshold.blocked-mvp-categories.example.json)
- [console.alert.connector-slo-target-missed.example.json](examples/console.alert.connector-slo-target-missed.example.json)
- [supervisor.health.connector-defaults-missing.example.json](examples/supervisor.health.connector-defaults-missing.example.json)
