...
class ContractLoaderTests(unittest.TestCase):
    def test_loads_all_v1_schemas(self):
        ...
        self.assertEqual(85, len(loader.schema_keys))
        self.assertIn("approval.readiness", loader.contract_names)
        ...
        self.assertIn("worker.channel.envelope", loader.contract_names)
        self.assertIn("worker.registration", loader.contract_names)
        ...
        self.assertIn("connector.reconciliation", loader.contract_names)
        self.assertIn("connector.acceptance_score", loader.contract_names)
        self.assertIn("connector.reconciliation_slo", loader.contract_names)
        self.assertIn("connector.ownership", loader.contract_names)
        self.assertIn("connector.escalation", loader.contract_names)
        self.assertIn("connector.defaults", loader.contract_names)
        self.assertIn("connector.slo_target", loader.contract_names)
        self.assertIn("connector.score_threshold", loader.contract_names)
        ...
        self.assertIn("supervisor.conversation.turn", loader.contract_names)
        self.assertIn("helper.assignment", loader.contract_names)
        self.assertIn("helper.result", loader.contract_names)
        self.assertIn("supervisor.task.proposal", loader.contract_names)
        self.assertIn("supervisor.approval.preview", loader.contract_names)
