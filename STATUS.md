...
- Current branch: `task-lifecycle-simulator-only`
- Current HEAD: narrow Phase 1B task-lifecycle simulator slice on top of audited worker-lifecycle simulator
...
- Doc-link check: `PASS` (`151` markdown files, `1076` local links checked)
