...
def build_guardian_decision(
    *,
    ...
    return {
        ...
        "replay_record_id": context.get("replay_record_id"),
        "replay_artifact_id": context.get("replay_artifact_id"),
        "denial_evidence_ref": context.get("denial_evidence_ref", evidence_id if denied else None),
        "pre_action_evidence_refs": context.get("pre_action_evidence_refs", [evidence_id] if denied else []),
        "post_action_evidence_refs": context.get("post_action_evidence_refs", evidence_ids if not denied else []),
        "export_manifest_refs": context.get("export_manifest_refs", []),
        "redaction_profile_ref": context.get("redaction_profile_ref", "metadata_only"),
        "hash_algorithm": context.get("hash_algorithm"),
        "content_hash": context.get("content_hash"),
        "parent_evidence_refs": context.get("parent_evidence_refs", []),
        "chain_position": context.get("chain_position"),
