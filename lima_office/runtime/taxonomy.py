...
REASON_CODE_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "helper_synthetic_review_assigned": {
        "category": "governance",
        "status": "active",
        "severity": "info",
        "visibility": "operator_visible",
    ...
    "unsupported_contact_preference": {
        "category": "reconciliation",
        "status": "active",
        "severity": "warning",
        "visibility": "operator_visible",
    ...
    "task_proposal_created": {
        "category": "governance", "status": "active", "severity": "info",
        "visibility": "operator_visible", "evidence_required": True,
        "fail_closed_required": True, "aliases": [],
    },
    ...
    "task_proposal_proposed": {
        "category": "governance", "status": "active", "severity": "info",
        "visibility": "operator_visible", "evidence_required": True,
        "fail_closed_required": True, "aliases": [],
    },
    "task_proposal_accepted_for_future_approval": {
        "category": "governance", "status": "active", "severity": "warning",
        "visibility": "operator_visible", "evidence_required": True,
        "fail_closed_required": True, "aliases": [],
    },
    "task_proposal_denied": {
        "category": "governance", "status": "active", "severity": "warning",
        "visibility": "operator_visible", "evidence_required": True,
        "fail_closed_required": True, "aliases": [],
    },
    "task_proposal_cancelled": {
        "category": "governance", "status": "active", "severity": "warning",
        "visibility": "operator_visible", "evidence_required": True,
        "fail_closed_required": True, "aliases": [],
    },
